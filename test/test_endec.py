...
class TestEncryptionDecryption:
    ...
    def test_encryption_returns_empty_string_encrypting_empty_string(self, set_unset_qradar_app_uuid_env_var,
    ...
    def test_decrypt_raises_error__when_config_missing(self, set_unset_qradar_app_uuid_env_var,
                                                       patch_get_store_path):
        enc = Encryption({"name": "test_name", "user": "test_user"})
        # ensure encrypted string does not equal plaintext
        enc_string = enc.encrypt('testing123')
